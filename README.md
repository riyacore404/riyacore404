...
```bash
{
  ...
  "looking"   : "collabs, internships, chaos",
  "sleep"     : false,
  "coffee"    : true,
  "regrets"   : null
}
...
i build fullstack apps, play with AI/ML models, occasionally write smart contracts, and sometimes go so low-level i forget what a browser is.
 
not a specialist. a **collector of half-finished side projects** who ships anyway. 🫡
